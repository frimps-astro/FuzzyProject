...
public class StarSyq extends Relterm {
    private final Relterm left;
    private final Relterm right;

    public StarSyq(Relterm left, Relterm right) {
        this.left = left;
        this.right = right;
    }
    ...
    public Relation execute(Map<String, Relation> rels, Map<String, SetObject> params, Basis basis) {
        return left.execute(rels, params, basis).starSyq(right.execute(rels, params, basis));
    }
