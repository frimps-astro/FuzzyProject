...
public class Meet extends Relterm {
    ...
    public Relation execute(Map<String, Relation> rels, Map<String, SetObject> params, Basis basis) {
        ...
        System.out.println(left.execute(rels, params, basis).getDom());
        System.out.println(left.execute(rels, params, basis).getCod());
        System.out.println(right.execute(rels, params, basis).getDom());
        System.out.println(right.execute(rels, params, basis).getCod());
