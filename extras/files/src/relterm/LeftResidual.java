...
public class LeftResidual extends Relterm {
    ...
    public Relation execute(Map<String, Relation> rels, Map<String, SetObject> params, Basis basis) {
        return left.execute(rels, params, basis).leftResidual(right.execute(rels, params, basis));
    }
