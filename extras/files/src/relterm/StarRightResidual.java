...
public class StarRightResidual extends Relterm {
    private final Relterm left;
    private final Relterm right;
    private static final int precedence = 30;

    public StarRightResidual(Relterm left, Relterm right) {
        this.left = left;
        this.right = right;
    }
    ...
    public Relation execute(Map<String, Relation> rels, Map<String, SetObject> params, Basis basis) {
        return left.execute(rels, params, basis).starRightResidual(right.execute(rels, params, basis));
    }
